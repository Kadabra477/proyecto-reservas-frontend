...
function Home({ estaAutenticado }) {
  ...
  useEffect(() => {
    if (estaAutenticado) {
      // Asegúrate que lees 'nombreCompleto' como lo guardas en Login.js
      ...
      <header className="header">
        <div className="header-container">
          ...
          <div className="auth-buttons">
            {estaAutenticado ? (
              <span className="welcome-message">Hola, {nombreUsuario}!</span>
            ) : (
              <>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            <Link to={estaAutenticado ? "/canchas" : "/login"} className="btn-main">Reservar ahora</Link>
      ...
      <section className="platform-preview">
         <div className="section-container">
           <div className="platform-content">
             ...
             <p>Nuestro sistema te permite encontrar y reservar canchas en cualquier momento desde tu computadora o celular.</p>
             <ul className="feature-list">
               <li>✓ Búsqueda por ubicación</li>
               <li>✓ Filtrado por deporte</li>
               <li>✓ Pagos online seguros</li>
             ...
             {/* Podrías añadir otro botón para usuarios autenticados si quieres */}
             {/* {estaAutenticado && (
                 <Link to="/canchas" className="btn-main">Buscar Canchas</Link>
             )} */}
           </div>
           <div className="platform-image">
             {/* Puedes reemplazar la URL placeholder con una imagen real */}
           </div>
         </div>
      </section>
      ...
      <footer className="footer">
         <div className="footer-content">
           ...
           <div className="footer-social">
             {/* Reemplaza # con enlaces reales si los tienes */}
         ...
         <div className="footer-bottom">
           {/* Código JS dentro de {} para obtener el año actual */}
