...
import './Home.css';
import ReservasSimplesImg from '../../assets/reservas-simples.jpg'; // Asegúrate que esta imagen exista en src/assets
...
function Home({ estaAutenticado }) {
  ...
  return (
    <main>
      {/* HEADER/NAV */}
      {/* Tu Navbar existente ya está siendo importada y usada en App.js,
          así que este header debería ser eliminado de aquí para evitar duplicación.
          Asumimos que el Navbar global de App.js es el que se usa. */}
      ...
      {/* PLATAFORMA (Reservas simples y rápidas) */}
      <section className="platform-preview">
          <div className="section-container">
            ...
            {/* Aquí va la imagen */}
            <div className="platform-image-container"> {/* Nuevo contenedor para la imagen */}
